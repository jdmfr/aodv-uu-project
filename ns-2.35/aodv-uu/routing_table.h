...
//16231053+++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    u_int32_t Cost;
    u_int32_t Channel;
//Add Cost and Channel to rt_trble+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
//16231053++++++++++++++++++++++++++
u_int32_t Func_La(struct in_addr src,struct in_addr dest);
u_int32_t Func_Cha(struct in_addr src,struct in_addr dest);
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
rt_table_t *rt_table_insert(struct in_addr dest, struct in_addr next,
                            ...
                            unsigned int ifindex,u_int32_t Cost,u_int32_t Channel);//16231053+++++++++++++++++++++++++++++++++++++++++++++++
...
int ARIMA_prediction(int time_chain[5]);
//end update
