...
//16231053++++++++++++++++
    AODV_msg *aodv_msg;
    int Channel;
    Channel = fixed_interface;
//Which channel does the RREP packet send from+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

    dest_addr.s_addr = ih->daddr();
    src_addr.s_addr = ih->saddr();
//++++++++++++++++++++++++++++++++++
    aodv_msg = (AODV_msg *) recv_buf;
//aodv_msg = (AODV_msg *) send_buf;
            ...
            for (int i = 0; i < nIfaces; ++i) {
                 if(aodv_msg->type == AODV_RREQ||aodv_msg->type == AODV_RRCQ||aodv_msg->type == AODV_RRDQ){
                    ((RREQ*) aodv_msg)->Channel=i;
					 ...
					 ((HELLO *) aodv_msg)->channel = i;	// updated by 1606
				 }
...
//+++++++++
        if(aodv_msg->type == AODV_RREP||aodv_msg->type == AODV_RRCP||aodv_msg->type == AODV_RRDP) {
			...
			Channel = ((HELLO*)aodv_msg)->channel;
		}
